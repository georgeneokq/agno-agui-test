...
def _create_events_from_chunk(
    ...
    # TODO: Get tool calls working with CopilotKit as well.
    #       Currently, output disappears when a tool call starts.
    #       I think it happens when a tool call starts during a text message output.
...
async def async_stream_agno_response_as_agui_events(
    ...
    async for chunk in response_stream:
        # Completion events to emit differs based on whether the run is for an Agent or a Team
